...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__  --sysroot=/opt/android-ndk-r8e/platforms/android-9/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=-mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__   -O3 -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__ -I../ffmpeg-build/armeabi-v7a-neon/include -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -I/Users/fschuetz/Dropbox/devel/android/FFMpeg/jni/libass/../ffmpeg-build/armeabi-v7a-neon/include -I/Users/fschuetz/Dropbox/devel/android/FFMpeg/jni/fribidi/../ffmpeg-build/armeabi-v7a-neon/include/fribidi -I/Users/fschuetz/Dropbox/devel/android/FFMpeg/jni/freetype2/../ffmpeg-build/x86/include/freetype2 -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
CXXFLAGS=-mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__   -D__STDC_CONSTANT_MACROS
ASFLAGS=  -O3 -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__ -I../ffmpeg-build/armeabi-v7a-neon/include -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LDFLAGS=-Wl,-rpath-link=/opt/android-ndk-r8e/platforms/android-9/arch-arm//usr/lib -L/opt/android-ndk-r8e/platforms/android-9/arch-arm//usr/lib -lc -lm -ldl -llog -Wl,-rpath-link=/opt/android-ndk-r8e/platforms/android-9/arch-arm//usr/lib -L/opt/android-ndk-r8e/platforms/android-9/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog -L../ffmpeg-build/armeabi-v7a-neon/lib  --sysroot=/opt/android-ndk-r8e/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
